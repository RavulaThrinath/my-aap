      ...
      >
        <h1 className="about-text">
          ...
          <p className="tessst">
            ...
            by multiple hustles. then we decided to invest in stock market.We
            thought investing in stock market was risk. Then finally we decided
            to invest with lower amount.Intially we didn't get profits. Then we
            took suggestions from my uncle who is investing in stocks from past
